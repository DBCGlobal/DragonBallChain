...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed1.DragonBallChain.net", "n1.DragonBallChain.net"));
        vSeeds.push_back(CDNSSeedData("seed2.DragonBallChain.net", "n2.DragonBallChain.net"));
