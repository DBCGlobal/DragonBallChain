...
Value submitaxcinproposal(const Array& params, bool fHelp) {
    ...
    if (fHelp || params.size() < 6 || params.size() > 7){
        ...
        throw runtime_error(
                ...
                "create proposal about transfer coin from other chain to DragonBallChain \n"
                "\nArguments:\n"
                "1.\"sender\":                      (string, required) the tx sender's address\n"
                ...
                "5.\"self_chain_uid\":              (string, required) initiator's uid at DragonBallChain \n"
...
Value submitaxcoutproposal(const Array& params, bool fHelp) {
    ...
    if (fHelp || params.size() < 4 || params.size() > 5){
        ...
        throw runtime_error(
                ...
                "create proposal about transfer coins from DragonBallChain to other chain\n"
                "\nArguments:\n"
                "1.\"sender\":                  (string,   required) the tx sender's address\n"
