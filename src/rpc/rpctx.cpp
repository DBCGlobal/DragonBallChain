...
// Copyright (c) 2017-2018 DragonBallChain Developers
    ...
    if (fHelp || params.size() < 3 || params.size() > 5) {
        throw runtime_error("submitluacontractdeploytx \"addr\" \"filepath\" \"fee\" [\"height\"] [\"contract_memo\"]\n"
            ...
            + HelpExampleCli("submitluacontractdeploytx",
                "\"WiZx6rrsBn9sHjwpvdwtMNNX2o31s3DEHH\" \"/tmp/lua/myapp.lua\" 100000000 10000 \"Hello, DragonBallChain!\"") +
                "\nAs json rpc call\n"
