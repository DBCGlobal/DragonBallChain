    ...
    if (fHelp || (params.size() < 3 && params.size() > 5))
        throw runtime_error(
                ...
                HelpExampleCli("submitsendtx",
                               ...
                               "\"WICC:1000000:sawi\" \"WICC:10000:sawi\" \"Hello, DragonBallChain!\"") +
                "\nAs json rpc call\n" +
    ...
    if (fHelp || (params.size() < 2 && params.size() > 4))
        throw runtime_error(
            ...
            HelpExampleCli("submitsendmultitx",
                           R"("wLKf2NqwtHk3BfzK5wMDfbKYN1SC3weyR4" "[{"to_uid":"0-1", "symbol_amount_unit":"WICC:100:WI"}]" "Hello, DragonBallChain!")") +
            "\nAs json rpc call\n" +
